...
class MyTextField2 extends StatefulWidget {
  ...
  @override
  _MyTextField22State createState() => _MyTextField22State();
}

class _MyTextField22State extends State<MyTextField2> {
  late FocusNode _focusNode;
  final ValueNotifier<bool> _focusNotifier = ValueNotifier<bool>(false);
  ...
  Widget build(BuildContext context) {
    return Animate(
      effects: [MoveEffect(begin: Offset(0, 10))],
      child: Padding(
        padding: EdgeInsets.only(bottom: widget.marginBottom!),
        child: GestureDetector(
          onTap: () {
                            ...
                            children: [
                              MyText(
                                ...
                                color: isFocused
                                    ? widget.focusedLabelColor ??
                                          getTertiary(context)
                                    : widget.labelColor ?? getTertiary(context),
                              ),
                              if (widget.isoptional == true)
                                MyText(
                                  text: ' (optional)',
                        ...
                        return TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            focusedBorder: widget.useOutlinedBorder == true
                                ...
                                : UnderlineInputBorder(
                                    borderSide: BorderSide(
                                      color: widget.bordercolor ?? kGrey5Color,
                                      width: 1.5,
                                    ),
                                  ),
                          ),
